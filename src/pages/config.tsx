...
export default function ConfigPage({ serverTime, appName, debugMode, serverConfig }: ConfigPageProps) {
  ...
  return (
    <>
      <Head>
        <title>Configuration Demo - {appName}</title>
        <meta name="description" content="Configuration system demonstration" />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
              Demonstrating Common, Client, and Server Configuration Usage
            </p>
          </div>
